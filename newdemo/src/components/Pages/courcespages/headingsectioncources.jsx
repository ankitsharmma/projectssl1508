...
const BestsellingCourses = () => {
  return (
    <div className="flex justify-between items-center p-6 bg-white w-full ">
      <div>
        <h2 className="text-3xl font-bold1  capitalize text-blue-400">Bestselling Courses</h2>
        <p className="text-gray-500  font-text1 text-sm">#Learn from bestselling courses</p>
      </div>
